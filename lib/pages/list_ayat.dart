...
import 'package:hafalan_quran/model/model_list_ayat.dart';
...
class ListAyat extends StatefulWidget {
  ...
  const ListAyat({Key key, this.suratke, this.namaSurat, this.jumlahAyat}) : super(key: key);
  @override
      ...
      child: new Card(
        ...
        child: new ListTile(
          ...
          title: Column(
            ...
            children: <Widget>[
              new Text(
               ayatArab.length > 10 ? "..."+ ayatArab.substring(0,15) : ayatArab,
